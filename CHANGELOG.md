...
- Bumped the Home Assistant add-on version to `0.1.1-beta.23` and set the
...
- Normalized stale `gpt-5.3-codex` / `gpt-5.5-codex` config values to
  `gpt-5.2-codex` at runtime.
